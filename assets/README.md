...
1. Org avatar: https://github.com/organizations/stableark/settings/profile → `avatar.png`
2. Repo social preview: https://github.com/stableark/stableark/settings → Social preview → `github-social.jpg`
